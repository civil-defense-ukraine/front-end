  ...
  return (
    <div className={styles.icons}>
      <a
        ...
        rel="noreferrer"
      >
        <div className={`${styles[classname]} icon icon--medium icon--hover icon--facebook`}></div>
      </a>
      <a
        target="_blank"
        ...
        rel="noreferrer"
      >
        <div className={`${styles[classname]} icon icon--medium icon--hover icon--instagram`}></div>
      </a>
      <a
        target="_blank"
        ...
        rel="noreferrer"
      >
        <div className={`${styles[classname]} icon  icon--medium icon--hover icon--linkedin`}></div>
      </a>
    </div>
  );
};
